...
class Stripe extends Component
{
    ...
    public function save()
    {
        ...
        $invoice = $stripe->createInvoice(Auth::User()->stripe_customer_id, $this->price->stripe_price_id, $paymentMethod->id, $this->price->country_code);

        $invoice = $stripe->finalizeInvoice($invoice->id);
